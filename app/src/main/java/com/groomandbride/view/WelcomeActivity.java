...
public class WelcomeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!SharedPrefsUtils.getInstance().isFirstTimeLaunch()) {
            launchHomeScreen();
            finish();
        }
    ...
    private void launchHomeScreen() {
        SharedPrefsUtils.getInstance().setFirstTimeLaunch(false);

        mHomeAllList = getIntent().getParcelableArrayListExtra("list");
